...
class ParseErrors {
  //Método que recebe o número do erro e retorna uma string conforme o número do erro passado
  static String getDescription(int error) {
    return _error[error].toString();
  }

  //Map com os erros relacionados a cada código
  static final Map<int, String> _error = {
    ...
    202: 'Email, CPF ou CNPJ informado já está cadastrado. Informe outro',
